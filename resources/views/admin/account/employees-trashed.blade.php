    ...
    <div class="content-wrapper">
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1>Employees are Trashed</h1>
                    </div>
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="/admin">Home</a></li>
                            <li class="breadcrumb-item">Employees are Trashed</li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
                                                ...
                                                <td>
                                                    @if ($employee->role != 'admin')
                                                        <form action="{{route('admin.account.restore', $employee->id)}}" method="post">
                                                            ...
                                                            <a href="{{ route('admin.account.showOrderChecked.employeeAccountTrashed', $employee->id) }}" class="btn btn-primary">Show orders checked</a>
                                                        </form>
                                                    @endif
                                                </td>
                                            @endif
