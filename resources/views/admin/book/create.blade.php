                                ...
                                <div class="row">
                                    <div class="col">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <input type="number" name="quantity" value="{{ old('quantity') }}" id="quantity" min="0" step="1" oninput="this.value = Math.round(this.value);" onchange="this.value < 0 ? this.value = 1 : this.value" class="form-control" placeholder="Enter quantity of Book" required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <input type="number" name="price" value="{{ old('price') }}" oninput="this.value = Math.round(this.value);" onchange="this.value < 0 ? this.value = 1 : this.value" min="1000" id="price" class="form-control" placeholder="Enter price of Book" required>
                                                <div class="input-group-append">
