                                ...
                                <div class="row">
                                    ...
                                    <div class="col">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <input type="number" name="price" value="{{ old('price') }}" oninput="this.value = Math.round(this.value);" id="price" class="form-control" placeholder="Enter price of Book" required>
                                                <div class="input-group-append">
